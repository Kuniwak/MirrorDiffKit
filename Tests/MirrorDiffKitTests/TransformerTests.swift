    ...
    func testTransform() {
        let testCases: [UInt: TestCase] = [
            ...
            #line: TestCase(
                ...
                target: .number(type: .type(Int.self), value: "10"),
                expected: true
            ),
            #line: TestCase(
                input: 10 as Int,
            ...
            #line: TestCase(
                input: 10 as Int8,
                target: .number(type: .type(Int8.self), value: "10"),
                expected: true
            ),
            #line: TestCase(
                input: 10 as UInt,
                target: .number(type: .type(UInt.self), value: "10"),
                expected: true
            ),
            #line: TestCase(
                input: 10 as UInt8,
                target: .number(type: .type(UInt8.self), value: "10"),
                expected: true
            ),
            #line: TestCase(
                input: -10,
            ...
            #line: TestCase(
                input: 3.14,
                target: .number(type: .type(Double.self), value: "3.14"),
                expected: true
            ),
            #line: TestCase(
                input: 3.14 as Float,
                target: .number(type: .type(Float.self), value: "3.14"),
                expected: true
            ),
            #line: TestCase(
                input: 3.14 as Float32,
                target: .number(type: .type(Float32.self), value: "3.14"),
                expected: true
            ),
            #line: TestCase(
                input: 3.14 as Float64,
                target: .number(type: .type(Float64.self), value: "3.14"),
                expected: true
            ),
            #line: TestCase(
                // NOTE: Use fake CGFloat on Linux.
                input: createCGFloat(3.14),
                target: .number(type: .type(CGFloatCompatibleWithLinux.self), value: "3.14"),
                expected: true
            ),
            ...
            #line: TestCase(
                input: "",
                target: .string(type: .type(String.self), content: ""),
                expected: true
            ),
            #line: TestCase(
                input: "string",
                target: .string(type: .type(String.self), content: "string"),
                expected: true
            ),
            #line: TestCase(
                input: "substring".prefix(3),
                target: .string(type: .type(Substring.self), content: "sub"),
                expected: true
            ),
            ...
            #line: TestCase(
                input: (),
                target: .tuple(type: .type(Void.self), entries: []),
                expected: true
            ),
            #line: TestCase(
                input: (10, 20),
                target: .tuple(type: .type((Int, Int).self), entries: [
                    .notLabeled(index: 0, value: .number(type: .type(Int.self), value: "10")),
                    .notLabeled(index: 1, value: .number(type: .type(Int.self), value: "20")),
                ]),
                expected: true
            ),
            #line: TestCase(
                ...
                target: TupleRepresentation.current.isAlmostLabeled
                    ? .tuple(type: .type((label1: Int, label2: Int).self), entries: [
                        .labeled(label: "label1", value: .number(type: .type(Int.self), value: "10")),
                        .labeled(label: "label2", value: .number(type: .type(Int.self), value: "20")),
                    ])
                    : .tuple(type: .type((label1: Int, label2: Int).self), entries: [
                        .notLabeled(index: 0, value: .number(type: .type(Int.self), value: "10")),
                        .notLabeled(index: 1, value: .number(type: .type(Int.self), value: "20")),
            ...
            #line: TestCase(
                input: Set<Int>([]),
                target: .set(type: .type(Set<Int>.self), elements: []),
                expected: true
            ),
            #line: TestCase(
                input: Set([1]),
                target: .set(type: .type(Set<Int>.self), elements: [
                    .number(type: .type(Int.self), value: "1"),
                ]),
                expected: true
            ),
            ...
            #line: TestCase(
                input: [Int](),
                target: .collection(type: .type(Array<Int>.self), elements: []),
                expected: true
            ),
            #line: TestCase(
                input: [1, 1, 2, 3, 5],
                target: .collection(type: .type(Array<Int>.self), elements: [
                    .number(type: .type(Int.self), value: "1"),
                    .number(type: .type(Int.self), value: "1"),
                    .number(type: .type(Int.self), value: "2"),
                    .number(type: .type(Int.self), value: "3"),
                    .number(type: .type(Int.self), value: "5"),
                ]),
                expected: true
            ),
            #line: TestCase(
                input: [[0, -1], [1, 0]],
                target: .collection(type: .type(Array<Array<Int>>.self), elements: [
                    .collection(type: .type(Array<Int>.self), elements: [.number(type: .type(Int.self), value: "0"), .number(type: .type(Int.self), value: "-1")]),
                    .collection(type: .type(Array<Int>.self), elements: [.number(type: .type(Int.self), value: "1"), .number(type: .type(Int.self), value: "0")]),
                ]),
                expected: true
            ),
            #line: TestCase(
                input: [0, 1, 2][0...2],
                target: .collection(type: .type(ArraySlice<Int>.self), elements: [
                    .number(type: .type(Int.self), value: "0"),
                    .number(type: .type(Int.self), value: "1"),
                    .number(type: .type(Int.self), value: "2"),
                ]),
                expected: true
            ...
            #line: TestCase(
                ...
                target: .anyStruct(
                    type: .type(StructStub.Optional.self),
                    entries: [
                        "value": .none,
                    ]
                ),
                ...
                target: .anyEnum(
                    ...
                    associated: [
                        TupleRepresentation.current.isFullyLabeled
                            ...
                            : .notLabeled(index: 0, value: .string(type: .type(String.self), content: "value")),
                    ]
                ),
                expected: true
            ),
            #line: TestCase(
                ...
                target: .anyEnum(
                    ...
                    associated: TupleRepresentation.current.isAlmostLabeled
                        ...
                        : [
                            .notLabeled(index: 0, value: .string(type: .type(String.self), content: "value1b")),
                            .notLabeled(index: 1, value: .string(type: .type(String.self), content: "value2b")),
                        ]
                ),
                expected: true
            ),
            ...
            #line: TestCase(
                ...
                target: .anyStruct(
                    type: .type(GenericStub<String>.self),
                    entries: [
                        "value": .string(type: .type(String.self), content: "string"),
                    ]
                ),
                expected: true
            ),
            ...
            #line: TestCase(
                ...
                target: .anyType(.type(StructStub.self)),
                expected: true
            ),
            ...
            #line: TestCase(
                input: "a".first!,
                target: .minorCustomReflectable(type: .type(Character.self), content: .empty(description: "a")),
                expected: true
            ),
            #line: TestCase(
                input: 0 ..< 5,
                target: .minorCustomReflectable(type: .type(Range<Int>.self), content: .notEmpty(entries: [
